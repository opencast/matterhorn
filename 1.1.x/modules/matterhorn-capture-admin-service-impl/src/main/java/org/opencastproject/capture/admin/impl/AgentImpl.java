...
public class AgentImpl implements Agent {
  ...
  /** Utility class to serialize the agent properties */
  ...
  private String xmlProps() {
    ...
    try {
      capabilitiesProperties.storeToXML(baos, "Capabilities for the agent " + this.name);
    } catch (IOException e) {
      result="Couldn't serialize this agent's capabilities";
    } 
