...
public class PersonComparator implements Comparator<Person> {
    ...
    public int compare(Person p1, Person p2) {
        ...
        if (c == 0) {
            ...
            if (c == 0) {
                EmailAddress email1 = p1.getPreferredEmailAddress();
                EmailAddress email2 = p1.getPreferredEmailAddress();
                if (email1 == null && email2 == null) c = 0;
                else if (email1 == null) c = 1;
                else if (email2 == null) c = -1;
                else c = unNull(email1.getAddress()).compareToIgnoreCase(unNull(email2.getAddress()));
            }
        }
        return c * ascending;
    }
