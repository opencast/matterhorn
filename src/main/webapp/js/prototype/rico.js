...
Rico.AjaxEngine.prototype = {
   ...
   _requestOptions: function(queryString,xmlDoc) {
      ...
      return { requestHeaders: requestHeaders,
               ...
               method:         sendMethod,
               onComplete:     self._onRequestComplete._bind(self) };
   },
   ...
   _mouseUpHandler: function(e) {
      ...
      if ( this._placeDraggableInDropZone(e) )
         ...
         new Effect.Position( this.dragElement,
                              ...
                              200,
                              20,
                              { complete : this._doCancelDragProcessing._bind(this) } );
      }
   },
...
Effect.SizeAndPosition.prototype = {
   ...
   sizeAndPosition: function() {
      ...
      this.timer = setTimeout(this.sizeAndPosition._bind(this), stepDuration);
   },
...
Effect.FadeTo.prototype = {
   ...
   fadeTo: function() {
      ...
      this.timer = setTimeout(this.fadeTo._bind(this), stepDuration);
   },
...
Effect.AccordionSize.prototype = {
   ...
   accordionSize: function() {
      ...
      this.timer = setTimeout(this.accordionSize._bind(this), stepDuration);
   },
...
Rico.LiveGridScroller.prototype = {
   ...
   handleScroll: function() {
     if ( this.scrollTimeout )
      ...
      this.scrollTimeout = setTimeout( this.scrollIdle._bind(this), 1200 );
   },
...
Rico.LiveGrid.prototype = {
   ...
   initialize: function( tableId, visibleRows, totalRows, url, options ) {
      ...
      options.sortHandler = this.sortHandler._bind(this);
   ...
   fetchBuffer: function(offset) {
      ...
      this.timeoutHandler = setTimeout( this.handleTimedOut._bind(this), 20000 ); //todo: make as option
   },
