 ...
 * Version 2.0.1.ced
 *
 * Slight modification by Christoph Drießen to allow for binding to select elements
 */
...
(function($) {
    ...
    $.fn.cookieBind = function(options) {
        return this.each(function() {
