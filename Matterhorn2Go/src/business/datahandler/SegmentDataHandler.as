...
{	
	...
	{		
		...
		private var description:XMLListCollection;
		...
		{			
			...
			description = new XMLListCollection(XMLResults.result.dcDescription);
		...
		public function getDescriptionListCollection():XMLListCollection
		{						
			return description;
		}
	}
