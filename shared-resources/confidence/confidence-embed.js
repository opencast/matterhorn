...
function AC_AddExtension(src, ext)
{
  ...
  return ret;
    ...
    else if (hasRequestedVersion)
    {
        ...
        AC_FL_RunContent("src", "ConfidenceMonitoring.swf", "width", "100%", "height", "100%", "align", "middle", "id", "oc_Videodisplay", "quality", "high", "bgcolor", "#FFFFFF", "name", "Videodisplay", "allowfullscreen", "true", "flashvars", "bridgeName=b_Videodisplay&amp;autoplay=false", "allowScriptAccess", "sameDomain", "type", "application/x-shockwave-flash", "wmode", "transparent", "pluginspage", "http://www.adobe.com/go/getflashplayer");
    }
    else
    {
