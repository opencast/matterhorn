...
echo "export OC_URL=http://opencast.jira.com/svn/MH/branches/1.x/" >> /home/opencast/.bashrc
...
svn co https://opencast.jira.com/svn/MH/branches/1.x $MATTERHORN_SRC_HOME
