...
public class DublinCoreCatalogImpl extends XMLCatalogImpl implements DublinCoreCatalog {
  ...
  /**
   * Namespace name of Dublin Core metadata generated by matterhorn. By default
   * this namespace is the default namespace of xml documents generated by this
   * class.
   */
  ...
  static final EName ROOT_ELEMENT = new EName(
          OPENCASTPROJECT_DUBLIN_CORE_NS_URI, "dublincore");
  ...
  public void set(EName property, DublinCoreValue value) {
    if (property == null)
      throw new IllegalArgumentException("Property name must not be null");
    if (value != null) {
      setValue(property, value.getValue(), value.getLanguage(), value
              .getEncodingScheme());
    } else {
  ...
  private void setValue(EName property, String value, String language,
  ...
  public void add(EName property, DublinCoreValue value) {
    ...
    add(property, value.getValue(), value.getLanguage(), value
            .getEncodingScheme());
  }

  private void add(EName property, String value, String language,
          EName encodingScheme) {
    if (LANGUAGE_UNDEFINED.equals(language)) {
  ...
  static class DublinCoreParser extends DefaultHandler {
    ...
    /**
     * Creates a new parser for dublin core documents. The parsed data will be
     * added to <code>dcCatalog</code>.
     * 
     * @param dcCatalog
     ...
     */
    public DublinCoreCatalogImpl parse(InputStream is) throws SAXException,
      ...
      if (!isDublinCore)
        throw new IllegalArgumentException(
                "Stream does not contain a dublin core document");
