...
public interface ElementTime {
  ...
  public void               setDur(float dur)
                                 throws DOMException;
  /**
   *  Causes the element to play repeatedly (loop) for the specified number of 
   * times. A negative value repeat the element indefinitely. Default value 
   * is 0 (undefined). 
   * @exception DOMException
   *    NO_MODIFICATION_ALLOWED_ERR: Raised if this attribute is readonly. 
   */
  ...
  public void               setRepeatCount(float repeatCount)
                                 throws DOMException;
  /**
   *  Causes the element to play repeatedly (loop) for the specified duration 
   * in milliseconds. Negative means "indefinite". 
   * @exception DOMException
   *    NO_MODIFICATION_ALLOWED_ERR: Raised if this attribute is readonly. 
   */
   ...
   * constraints). 
   * @return  <code>true</code> if the method call was successful and the 
   *   element was endeed. <code>false</code> if method call failed. Possible 
   ...
   * @param seekTo  The desired position on the local timeline.  
   */
