...
public class VideoEditorPipeline {
    ...
    protected void addListener() {
        pipeline.getBus().connect(new Bus.INFO() {
             ...
             * {@inheritDoc}
             *
             * @see org.gstreamer.Bus.INFO#infoMessage(org.gstreamer.GstObject,
        ...
        pipeline.getBus().connect(new Bus.ERROR() {
             ...
             *
             * @see
             * org.gstreamer.Bus.ERROR#errorMessage(org.gstreamer.GstObject,
             * int, java.lang.String)
             */
            @Override
        ...
        pipeline.getBus().connect(new Bus.WARNING() {
             ...
             *
             * @see
             * org.gstreamer.Bus.WARNING#warningMessage(org.gstreamer.GstObject,
             * int, java.lang.String)
             */
            @Override
