...
public class CaptionEmbedderWorkflowOperationHandler extends AbstractWorkflowOperationHandler {
  ...
  public WorkflowOperationResult start(WorkflowInstance workflowInstance) throws WorkflowOperationException {
    ...
    MediaPackage result;
    try {
      result = embed(workflowInstance.getMediaPackage(), workflowInstance.getCurrentOperation());
    } catch (Exception e) {
      throw new WorkflowOperationException(e);
    }

    return WorkflowBuilder.getInstance().buildWorkflowOperationResult(result, Action.CONTINUE);
  }
   ...
   */
  private MediaPackage embed(MediaPackage src, WorkflowOperationInstance operation) throws Exception {
      ...
      for (String language : languages) {
        if (!captionLanguages.contains(language)) {
          ...
          convertedCaption.setURI(workspace.moveTo(convertedCaption.getURI(), mediaPackage.getIdentifier().toString(),
                  convertedCaption.getIdentifier()));
