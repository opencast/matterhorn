...
/**
 * This exception is thrown during speech recognition.
 */
public class SpeechAnalyzerException extends Exception {
   ...
   */
  public SpeechAnalyzerException(String message) {
    super(message);
  }
   ...
   */
  public SpeechAnalyzerException(Throwable cause) {
    super(cause);
  }
   ...
   *          the root cause for the failure
   */
  public SpeechAnalyzerException(String message, Throwable cause) {
    super(message, cause);
  }
